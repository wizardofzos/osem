...
describe Track do
  ...
  describe 'validation' do
    ...
    it "validates uniqueness of short_name" do
      skip "there is a bug: https://github.com/thoughtbot/shoulda-matchers/issues/814" do
        is_expected.to validate_uniqueness_of(:short_name).ignoring_case_sensitivity.scoped_to(:program)
      end
    end 
